...
apply couple_morph.
 ...
 apply H1.
  ...
  apply fst_morph; trivial.
  apply snd_typ_sigma with (1:=H2); reflexivity.
  apply snd_morph; trivial.
Qed.
...
apply tyg; trivial.
apply snd_typ_sigma with (1:=tyx); reflexivity.
Qed.
...
constructor; intros.
 ...
 apply (iso_inj (H3 _ _ H7 (reflexivity _))) in H9.
  ...
  apply snd_typ_sigma with (1:=H4); reflexivity.

  apply snd_typ_sigma with (1:=H5); auto with *.
...
constructor; intros; auto with *.
 red; intros.
 apply snd_typ_sigma with (1:=H0); trivial.
